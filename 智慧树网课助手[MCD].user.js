...
// @namespace    MCDream
// @version      4.0.3.6
// @description  【无需TOKEN】自动挂机看知到MOOC，支持屏蔽弹窗题目、自动切换下一节，章测试和考试支持自动答题，视频自动倍速播放、线路选择、默认静音等，解除各类功能限制，开放自定义参数 仅作接口更换，稳定性未知！！建议夜深人静时悄悄食用
...
function beforeFind() {
  ...
  setting.div = $(
    '<div style="border: 2px dashed rgba(255,12,0,0.7); width: 330px; position: fixed; top: 0; left: 0; z-index: 99999; background-color: rgba(255,250,110,0.6); overflow-x: auto;">' +
